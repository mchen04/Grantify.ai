...
router.get('/',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      const service = grantsService;
      logger.info(`Using REAL grants service`);
...
router.get('/recommended',
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      // Determine which service to use
      const service = grantsService;
      logger.info(`Using REAL grants service for recommendations`);
      ...
      const grants = await service.getRecommendedGrants(req.supabase, userId, {
        exclude,
        limit
      });
...
router.get('/similar',
  async (req: Request, res: Response) => {
    try {
      ...
      // Determine which service to use
      const service = grantsService;
      logger.info(`Using REAL grants service for similar grants`);
